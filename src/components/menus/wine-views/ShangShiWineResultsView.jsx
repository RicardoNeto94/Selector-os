...
export default function ShangShiWineResultsView({ menu, items, filters = {}, onBack }) {
                ...
                <div className="space-y-8 mt-8">
                  ...
                  {sortedWines.map((item) => {
                    ...
                    return (
                      <div
                        key={item.id}
                        className="flex justify-between items-start pb-6 border-b border-white/10 transition"
                      >
                        <div className="max-w-[75%]">

                          <p className="text-[17px] text-white tracking-wide">
                            {w.name}
                          </p>
                        ...
                        <div className="text-[#c9a96a] text-[16px]">
                          €{w.price}
                        </div>
