...
export default function SelectPlanClient({ restaurantName }) {
  ...
  function handleEnterprise() {
    window.location.href =
      "mailto:ricardoneto8@gmail.com?subject=SelectorOS%20Enterprise%20plan";
  }

  return (
    <div className="page-fade rounded-[28px] bg-slate-950/80 border border-slate-800/80 shadow-[0_22px_60px_rgba(0,0,0,0.85)] px-6 py-7 md:px-8 md:py-8 space-y-8">
      {/* Header */}
      <header className="mb-1">
        <p className="text-[10px] uppercase tracking-[0.25em] text-emerald-400/80 mb-2">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-5">
        {/* Starter / Standard */}
        <div className="rounded-3xl bg-slate-950 border border-slate-800/90 p-5 flex flex-col gap-3 shadow-[0_18px_40px_rgba(0,0,0,0.8)]">
          <div>
          ...
          <div className="flex items-baseline gap-1">
            <span className="text-lg font-semibold text-slate-50">€19.99</span>
