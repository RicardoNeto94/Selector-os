...
export default async function DashboardPage() {
  ...
  // 7) Allergens in library (per restaurant) – simple + safe
  ...
  const totalAllergens = allergensData ? allergensData.length : 0;
  ...
  if (totalDishes > 0) {
    ...
    if (dishAllergensError) {
      console.error(
        "Dashboard: error loading dish_allergens",
        dishAllergensError
      );
    } else {
        ...
        <section className="so-grid-lg mt-1">
            ...
            <div className="mt-3 text-xs text-slate-500 space-y-2">
              {totalDishes === 0 && (
                <div>
                  ...
                  <p className="text-slate-500">
                    Start by creating at least one dish in your workspace so
                    staff can see something in the live view.
                  </p>
                </div>
              )}
              ...
              {totalAllergens === 0 && (
                <div className="pt-2 border-t border-slate-200/70">
                  ...
                  <p className="text-slate-500">
                    Go to <strong>Settings → Allergens</strong> and add your
                    base allergen list (GL, EG, SO…).
                  </p>
                </div>
              )}
            </div>
          ...
          <article className="so-card">
            ...
            <p className="mt-3 text-[11px] text-slate-400">
              As you add menus, dishes and allergens, this panel will keep a
              quick summary of how “service-ready” your SelectorOS workspace is.
            </p>
          </article>
        </section>
      </div>
