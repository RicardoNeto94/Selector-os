...
export default async function SettingsPage() {
  ...
  // ERROR STATE – no <main>, just a content wrapper
  if (restaurantError || !restaurant) {
    console.error("No restaurant for user", restaurantError);
    return (
      <div className="page-fade max-w-3xl mx-auto w-full text-slate-900">
        <div className="mt-4 rounded-3xl border border-red-500/30 bg-red-50/80 p-6 shadow-lg">
  ...
  return (
    <div className="page-fade max-w-6xl mx-auto w-full space-y-6 text-slate-900">
      {/* PAGE HEADER */}
