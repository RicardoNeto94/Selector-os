  ...
  return (
    <main className="page-fade px-6 py-10 text-slate-900">
      <div className="max-w-6xl mx-auto space-y-8">
        {/* PAGE HEADER */}
        <section className="rounded-[32px] bg-white/90 backdrop-blur-xl shadow-[0_24px_70px_rgba(15,23,42,0.18)] border border-slate-200/70 px-8 py-6 flex flex-col gap-1">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-[minmax(0,2.1fr)_minmax(0,1fr)] gap-6 items-start">
          {/* LEFT: Appearance form – fills most of the width */}
          <div>
          ...
          <aside className="rounded-[32px] bg-white/80 backdrop-blur-xl border border-slate-200/70 shadow-[0_18px_55px_rgba(15,23,42,0.16)] px-6 py-6 flex flex-col gap-3">
            ...
            <div className="mt-4 rounded-2xl border border-dashed border-slate-300/80 bg-slate-50/80 px-4 py-3 text-xs text-slate-500">
